...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  await deployConnector(
    ...
    [SUBSIDY_PRINCIPAL, SUBSIDY_PROFIT, SUBSIDY_HOLDER_ADDRESS_MAINNET, UNI_V3_FACTORY]
  )
  ...
  await deployConnector(
    ...
    [SUBSIDY_PRINCIPAL, SUBSIDY_PROFIT, SUBSIDY_REWARDS, SUBSIDY_HOLDER_ADDRESS_MAINNET, UNI_V3_FACTORY]
  )
}
