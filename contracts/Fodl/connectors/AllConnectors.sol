...
import { IAavePositionIncreaseConnector } from './interfaces/IAavePositionIncreaseConnector.sol';
import { IAavePositionDecreaseConnector } from './interfaces/IAavePositionDecreaseConnector.sol';
...
interface AllConnectors is
    ...
    IFundsManagerConnector,
    IAavePositionIncreaseConnector,
    IAavePositionDecreaseConnector
{
