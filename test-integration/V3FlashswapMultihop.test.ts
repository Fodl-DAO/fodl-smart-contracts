...
import { COMPOUND_PLATFORM, AAVE_PLATFORM, SUBSIDY_HOLDER_ADDRESS_MAINNET } from '../constants/deploy'
...
describe('V3FlashswapMultihop', () => {
  ...
  describe('when supply token != borrow token', () => {
    ...
    const TESTS_TABLE: ITEST_TABLE[] = [
      ...
      // Aave tests superseded by AaveOneInchConnector.test.ts - Disabling for test speed
